...
extern void SV_SetOrigin( edict_t* pedict, const Vector& origin, bool realignEntity = false );
extern void SV_SetAngles( edict_t* pedict, const Vector& angles, bool realignEntity = false );
...
extern bool SV_SetEntityParent( edict_t* pentity, edict_t* pparent );
#endif