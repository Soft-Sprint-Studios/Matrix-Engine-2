...
extern bool PBSPV2_LoadDisplacements( const byte* pfile, brushmodel_t& model, const dpbspv2lump_t& lump );
extern bool PBSPV2_LoadChecksum( const byte* pfile, brushmodel_t& model, const dpbspv2lump_t& lump );
#endif //PBSPV2_H