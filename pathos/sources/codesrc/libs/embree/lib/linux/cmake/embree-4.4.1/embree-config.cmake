...
IF (EMBREE_STATIC_LIB)
  ...
  INCLUDE("${EMBREE_ROOT_DIR}/lib64/cmake/embree-4.4.1/sys-targets.cmake")
  INCLUDE("${EMBREE_ROOT_DIR}/lib64/cmake/embree-4.4.1/math-targets.cmake")
  INCLUDE("${EMBREE_ROOT_DIR}/lib64/cmake/embree-4.4.1/simd-targets.cmake")
  INCLUDE("${EMBREE_ROOT_DIR}/lib64/cmake/embree-4.4.1/lexers-targets.cmake")
  INCLUDE("${EMBREE_ROOT_DIR}/lib64/cmake/embree-4.4.1/tasking-targets.cmake")

  IF (EMBREE_ISA_SSE42)
    INCLUDE("${EMBREE_ROOT_DIR}/lib64/cmake/embree-4.4.1/embree_sse42-targets.cmake")
  ENDIF()

  IF (EMBREE_ISA_AVX)
    INCLUDE("${EMBREE_ROOT_DIR}/lib64/cmake/embree-4.4.1/embree_avx-targets.cmake")
  ENDIF()

  IF (EMBREE_ISA_AVX2)
    INCLUDE("${EMBREE_ROOT_DIR}/lib64/cmake/embree-4.4.1/embree_avx2-targets.cmake")
  ENDIF()

  IF (EMBREE_ISA_AVX512)
    INCLUDE("${EMBREE_ROOT_DIR}/lib64/cmake/embree-4.4.1/embree_avx512-targets.cmake")
  ENDIF()
...
IF (EMBREE_SYCL_SUPPORT)
  ...
  IF (EMBREE_SYCL_RT_VALIDATION_API)
    INCLUDE("${EMBREE_ROOT_DIR}/lib64/cmake/embree-4.4.1/embree_rthwif_sycl-targets.cmake")
  ENDIF()
  IF (EMBREE_STATIC_LIB)
    INCLUDE("${EMBREE_ROOT_DIR}/lib64/cmake/embree-4.4.1/embree_rthwif-targets.cmake")
    INCLUDE("${EMBREE_ROOT_DIR}/lib64/cmake/embree-4.4.1/ze_wrapper-targets.cmake")
  ENDIF()
  INCLUDE("${EMBREE_ROOT_DIR}/lib64/cmake/embree-4.4.1/embree_sycl-targets.cmake")

ENDIF()

INCLUDE("${EMBREE_ROOT_DIR}/lib64/cmake/embree-4.4.1/embree-targets.cmake")


SET(EMBREE_TESTING_ONLY_SYCL_TESTS OFF)
SET(EMBREE_TESTING_INTENSITY 3)
