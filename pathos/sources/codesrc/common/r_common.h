...
extern void R_BuildLightmap( Uint16 light_s, Uint16 light_t, const void *psamples, const msurface_t *psurface, void *pout, Int32 index, Uint32 sizex, Uint32 padamount, bool isvectormap = false, bool fullbright = false, bool isfloat = false );
