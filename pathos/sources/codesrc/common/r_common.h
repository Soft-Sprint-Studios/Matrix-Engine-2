...
extern void R_BuildLightmap( Uint16 light_s, Uint16 light_t, const color24_t *psamples, const msurface_t *psurface, color32_t *pout, Int32 index, Uint32 sizex, Uint32 padamount, bool isvectormap = false, bool fullbright = false );
